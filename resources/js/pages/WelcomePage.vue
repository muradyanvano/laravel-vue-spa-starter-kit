...
const documentationUrl =
    'https://github.com/muradyanvano/laravel-vue-spa-starter-kit#readme';
</script>
...
<template>
    ...
    >
        ...
        >
            ...
            >
                <RouterLink
                    v-if="user"
                    to="/dashboard"
                    class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#19140035] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b] dark:focus-visible:outline-[#62605b]"
                >
                    Dashboard
                </RouterLink>
                <template v-else>
                    <RouterLink
                        to="/login"
                        class="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#19140035] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A] dark:focus-visible:outline-[#62605b]"
                    >
                        Log in
                    </RouterLink>
                    <RouterLink
        ...
        <div
            class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 motion-reduce:transition-none lg:grow starting:opacity-0"
        >
            <main
            ...
            >
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        A community starter kit for first-party Vue SPAs — Vue
                        Router, Fortify, and Sanctum, without Inertia.
                    </p>
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                class="inline-block rounded-sm border border-black bg-[#1b1b18] px-5 py-1.5 text-sm leading-normal text-white hover:border-black hover:bg-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1b1b18] dark:border-[#eeeeec] dark:bg-[#eeeeec] dark:text-[#1C1C1A] dark:hover:border-white dark:hover:bg-white dark:focus-visible:outline-[#eeeeec]"
                            >
                                Deploy now
                            </a>
                        </li>
                ...
                >
                    <!-- Laravel Logo -->
                    <svg
                        class="w-full max-w-none translate-y-0 text-[#F53003] opacity-100 transition-all duration-750 motion-reduce:transition-none dark:text-[#F61500] starting:opacity-0 motion-safe:starting:translate-y-6"
                        viewBox="0 0 438 104"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
